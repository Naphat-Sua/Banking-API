...
export default {
  ...
  methods: {
    async addSubmit() {
      ...
      this.modal_add.data.from_name = this.modal_add.data.from_name ? this.modal_add.data.from_name : null
      this.modal_add.data.from_bank = this.modal_add.data.from_bank ? this.modal_add.data.from_bank : null
      this.modal_add.data.from_account = this.modal_add.data.from_account ? this.modal_add.data.from_account : null
      this.modal_add.data.qrcode = this.modal_add.data.qrcode ? true : false
      this.modal_add.data.send_callback = this.modal_add.data.send_callback ? true : false
    ...
    async getData(exportData) {
      ...
      if (exportData == "export") {
        const Result = await this.$callapi.callAPIHandler(
          this.axios.get(this.$api.deposit.export, {params: queryString})
        );
        if (Result.data) {
          this.$notify({
        ...
        const Result = await this.$callapi.callAPIHandler(
          this.axios.get(this.$api.deposit.get, {params: queryString})
        );
        if (Result.data) {
