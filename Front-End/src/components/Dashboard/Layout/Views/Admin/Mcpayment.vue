<template>
  <div>
    <card>
      ...
      <div class="row">
        <fg-input class="col-sm-3" label="Customer">
          <el-select class="select-default" placeholder="Please customer"
                     v-model="search.customer">
            <el-option v-for="option in select.customer"
                       :value="option.value"
                       :label="option.label"
                       :key="option.value">
            </el-option>
        ...
        <fg-input class="col-sm-2" label="TypePayment">
    ...
    <card>
      ...
      <div class="row">
        ...
        >
          ...
          <el-table-column min-width="150" label="Merchant">
            <div slot-scope="props">
              <div v-if="props.row.merchant">
                <div><strong>Merchant:</strong></div>
                <div>{{ props.row.merchant.name }}</div>
                <div><strong>Mid:</strong></div>
                <div>{{ props.row.merchant.mid }}</div>
                <div><strong>ENV:</strong></div>
                <div>{{ props.row.merchant.env }}</div>
              </div>
            </div>
          </el-table-column>
