...
<script>
import Order from '../../../CustomComponent/PiPayWallet/Order.vue'
  ...
  methods: {
    async getData() {
     this.load_data = true
      ...
      const Result = await this.$callapi.callAPIHandler(this.axios.get(this.$api.pipay.getOrders, {params: queryString}))
      if (Result.data) {
