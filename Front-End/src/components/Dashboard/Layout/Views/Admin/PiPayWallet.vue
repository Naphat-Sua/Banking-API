...
<script>
import AddMerchant from '../../../CustomComponent/PiPayWallet/AddMerchant.vue'
import Merchant from '../../../CustomComponent/PiPayWallet/Merchant.vue'
...
export default {
    ...
    methods: {
        ...
        async getData() {
            ...
            const Result = await this.$callapi.callAPIHandler(this.axios.get(this.$api.pipay.get, { params: queryString }));
            if (Result.data) {
        ...
        async onSubmitAddMerchant() {
           ...
           const Result = await this.$callapi.callAPIHandler(this.axios.post(this.$api.pipay.add, this.modal.data));
        ...
        async onSubmitEdit() {
            ...
            const Result = await this.$callapi.callAPIHandler(this.axios.patch(this.$api.pipay.edit, this.modal.data));
            if (Result.data) {
                this.$notify({
