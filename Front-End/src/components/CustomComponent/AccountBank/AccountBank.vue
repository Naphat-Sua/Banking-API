  ...
  <div class="row">
    <div class="col-sm-12">
      <el-table stripe border v-loading="load_data"
        ...
        <el-table-column min-width="180" prop="account" label="Account Number"/>
        <el-table-column min-width="180" prop="name" label="Account Name"/>
        <el-table-column min-width="150" prop="type.name" label="Bank"/>
        <el-table-column min-width="150" prop="promptpay" label="Promtppay"/>
